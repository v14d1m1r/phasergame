...
export default class extends Phaser.State {
  ...
  setUpText () {
    this.scoreText = this.createText(19, 20, 'left', `Score: ${this.game.global.score}`)
    this.livesText = this.createText(0, 20, 'center', `Lives: ${this.game.global.lives}`)
    this.levelText = this.createText(-19, 20, 'right', `Level: ${this.game.global.level}`)
  }
